...
from .views import RegistrationView, ActivationView, LoginView, RegistrationTemplateView, activation_view, LoginTemplateView, DashboardView, ResetPasswordView, ResetPasswordConfirm, RegistrationPhoneView
